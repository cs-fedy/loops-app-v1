...
export class SkillToQuizStrategy extends BaseNavigationStrategy {
  ...
  navigate(
    ...
    if (!this.canNavigate(context))
      return Effect.fail({
        ...
        message: "Cannot navigate from skill to quiz",
      })
    ...
    return Effect.gen(function* () {
      if (adjacentItem.contentType !== "quizzes")
        yield* Effect.fail({
          _tag: "InvalidContentType" as const,
          message: "Expected next item to be a quiz",
        })
